    ...
    <div className="min-h-screen bg-[#0B1020] text-[#F9FAFB] flex items-center justify-center relative px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-mutedText mt-1.5">Sign in to manage your virtual assets</p>
        </div>
        ...
        <div className="glass-card p-8 rounded-2xl border border-white/5 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary hover:bg-primary/95 text-black font-bold py-3 rounded-xl shadow-lg shadow-primary/10 transition-all flex items-center justify-center space-x-2"
            >
              {loading ? (
